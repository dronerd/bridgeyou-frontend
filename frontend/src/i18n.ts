...
export const translations: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    step2: "Choose the language you want to speak in",
    step3: "Choose the target country to specialize in",
  },
  ja: {
    title: "BridgeYou チャット",
    subtitle: "意図を伝え、友人を作る — 丁寧で分かりやすく、文化に配慮した表現にします。",
  ...
  de: {
    ...
    step2: "Wählen Sie die Sprache, in der Sie sprechen möchten",
    step3: "Wählen Sie das Zielland zur Spezialisierung",
  },
  fr: {
    title: "BridgeYou Chat",
    ...
    step2: "Choisissez la langue dans laquelle vous voulez parler",
    step3: "Choisissez le pays cible pour la spécialisation",
  },
  es: {
    title: "BridgeYou Chat",
    ...
    step2: "Elige el idioma en el que quieres hablar",
    step3: "Elige el país objetivo para especializarte",
  },
};
